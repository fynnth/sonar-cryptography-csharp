...
public class CSharpParserBaseVisitor<T> extends AbstractParseTreeVisitor<T>
     ...
     */
    @Override
    public T visitStackallocExpression(CSharpParser.StackallocExpressionContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitAnonymous_object_initializer(
     ...
     */
    @Override
    public T visitAnonymous_function_signature(
     ...
     */
    @Override
    public T visitForeachDeconstructStatement(CSharpParser.ForeachDeconstructStatementContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitPattern(CSharpParser.PatternContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitVariable_designation(CSharpParser.Variable_designationContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitParenthesized_variable_designation(
     ...
     */
    @Override
    public T visitSimple_designation(CSharpParser.Simple_designationContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitNamespace_member_declaration(
     ...
     */
    @Override
    public T visitInterface_member_declaration(
     ...
     */
    @Override
    public T visitFixed_size_buffer_declarator(
