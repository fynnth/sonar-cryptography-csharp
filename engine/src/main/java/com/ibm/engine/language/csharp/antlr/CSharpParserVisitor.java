...
public interface CSharpParserVisitor<T> extends ParseTreeVisitor<T> {
    ...
    /**
     * Visit a parse tree produced by the {@code parenthesisExpressions} labeled alternative in
    ...
    /**
     * Visit a parse tree produced by the {@code memberAccessExpression} labeled alternative in
     * {@link CSharpParser#primary_expression_start}.
     *
     * @param ctx the parse tree
     * @return the visitor result
    ...
    /**
     * Visit a parse tree produced by the {@code defaultValueExpression} labeled alternative in
     * {@link CSharpParser#primary_expression_start}.
     *
     * @param ctx the parse tree
     * @return the visitor result
    ...
    /**
     * Visit a parse tree produced by the {@code stackallocExpression} labeled alternative in {@link
     * CSharpParser#primary_expression_start}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitStackallocExpression(CSharpParser.StackallocExpressionContext ctx);
     ...
     * @return the visitor result
     */
    T visitObject_or_collection_initializer(
    ...
    /**
     * Visit a parse tree produced by the {@code foreachDeconstructStatement} labeled alternative in
     * {@link CSharpParser#simple_embedded_statement}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitForeachDeconstructStatement(CSharpParser.ForeachDeconstructStatementContext ctx);
    ...
    /**
     * Visit a parse tree produced by {@link CSharpParser#pattern}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitPattern(CSharpParser.PatternContext ctx);

    /**
     * Visit a parse tree produced by {@link CSharpParser#variable_designation}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitVariable_designation(CSharpParser.Variable_designationContext ctx);

    /**
     * Visit a parse tree produced by {@link CSharpParser#parenthesized_variable_designation}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitParenthesized_variable_designation(
            CSharpParser.Parenthesized_variable_designationContext ctx);

    /**
     * Visit a parse tree produced by {@link CSharpParser#simple_designation}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitSimple_designation(CSharpParser.Simple_designationContext ctx);
     ...
     * @return the visitor result
     */
    T visitInterpolated_regular_string_part(
