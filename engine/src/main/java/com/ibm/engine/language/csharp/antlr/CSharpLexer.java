...
public class CSharpLexer extends CSharpLexerBase {
    ...
    public static final int BYTE_ORDER_MARK = 1,
            ...
            OP_RANGE = 171,
            SKIPPED_SECTION = 172,
            DOUBLE_CURLY_INSIDE = 173,
            OPEN_BRACE_INSIDE = 174,
            REGULAR_CHAR_INSIDE = 175,
            VERBATIUM_DOUBLE_QUOTE_INSIDE = 176,
            DOUBLE_QUOTE_INSIDE = 177,
            REGULAR_STRING_INSIDE = 178,
            VERBATIUM_INSIDE_STRING = 179,
            CLOSE_BRACE_INSIDE = 180,
            FORMAT_STRING = 181,
            DIRECTIVE_WHITESPACES = 182,
            DIGITS = 183,
            DEFINE = 184,
            UNDEF = 185,
            ELIF = 186,
            ...
            PRAGMA = 193,
            NULLABLE = 194,
            DIRECTIVE_HIDDEN = 195,
            CONDITIONAL_SYMBOL = 196,
            DIRECTIVE_NEW_LINE = 197,
            TEXT = 198,
            DOUBLE_CURLY_CLOSE_INSIDE = 199;
